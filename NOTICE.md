...
*   LLVM: [https://llvm.org/](https://llvm.org/)
    ...
    *   License: [https://llvm.org/LICENSE.txt](https://llvm.org/LICENSE.txt)
*   Eigen: [https://eigen.tuxfamily.org/](https://eigen.tuxfamily.org/)
    *   Licensed under the Mozilla Public License 2.0 (MPL 2.0)
    *   Copyright (c) 2005-2022 Eigen Developers
    *   License: [https://www.mozilla.org/MPL/2.0/](https://www.mozilla.org/MPL/2.0/)
*   Perl: [https://www.perl.org/](https://www.perl.org/)
    ...
    *   License: [https://www.perlfoundation.org/artistic-license-20.html](https://www.perlfoundation.org/artistic-license-20.html) and [https://www.gnu.org/licenses/old-licenses/gpl-1.0.html](https://www.gnu.org/licenses/old-licenses/gpl-1.0.html)
